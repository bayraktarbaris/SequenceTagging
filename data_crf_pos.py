...
class DataReaderCRF_POS(DataReaderCRF):
    '''
    ...
    def extract_sentences(self):
        self.sentences = [[tkn for tkn, _, _ in sent] for sent in self.data]
...
if __name__ == '__main__':
    data = DataReaderCRF_POS('data_mini/pos/en-ud-train.conllu')
    print(len(data.data))
    print()
    print(data.data[0])
    print()
